...
#SBATCH -o ./delta_logs/baseline.out
...
echo "Running"
cd aot_plus
python tools/train.py --amp --exp_name baseline --stage pre_vost --model r50_aotl --gpu_num 4 --batch_size 8 \
    --fix_random --pretrained_path ../pretrained_models/R50_AOTL_PRE_YTB_DAV.pth